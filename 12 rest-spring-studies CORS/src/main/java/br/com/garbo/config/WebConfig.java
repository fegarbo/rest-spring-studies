...
public class WebConfig implements WebMvcConfigurer{
	...
	public void configureContentNegotiation(ContentNegotiationConfigurer configurer) {
		...
		//Via Header: http://localhost:8080/api/person/v1      Ex: Accept = application/xml
	...
	//Enable access for all application without CORS problem
	//Works for basic operations(PUT, DELETE, POST and GET)
	/*
